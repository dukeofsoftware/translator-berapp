...
const useStyles = createStyles((theme) => ({
 ...
 const footerData = [
    ...
    },
    {
        title:"Social",
        links:[
            {label:"Github",link:"https://github.com/dukeofsoftware/translator-berapp"},
            {label:"Linkedin",link:"https://www.linkedin.com/in/furkan-emre-kozan/"},
            {label:"Instagram",link:"https://www.instagram.com/artikyorgunhissediyor/"},
            ...
            <Container className={classes.inner}>
                <div className={classes.logo}>
                    ...
                    <Text size="xs" color="dimmed" className={classes.description}>
                        Translator is a free, open-source, and community-driven translation platform.
                    </Text>
                </div>
